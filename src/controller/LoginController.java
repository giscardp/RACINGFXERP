...
public class LoginController implements Initializable {
    ...
    private void Login(ActionEvent event) throws IOException{
        ...
        if(username_text.equals("")||password_text.equals("")){
            nav.showAlert(AlertType.WARNING, "Advertencia", null, "Por favor ingrese su nombre de usuario y contraseña primero !!");
            ...
            if(log.getLogin()==true){
                if(log.getStatus().equals("Login")){
                    nav.showAlert(AlertType.ERROR, "Error", null, "El nombre de usuario está actualmente conectado !!");
                    username.requestFocus();
                }
                else{
                ...
                nav.showAlert(AlertType.ERROR, "Error", null, "El nombre de usuario y la contraseña que ingresaste son incorrectos !!");
                username.setText("");
                password.setText("");
                username.requestFocus();
            }
